  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <Card
          className="p-0 cursor-pointer transition duration-300 hover:shadow-md"
        ...
        >
          <CardContent
            className={`p-0 ${viewMode === "list" ? "flex" : "flex flex-col"}`}
          >
            <div
                  ...
                  >
                    {note.is_favourite ? (
                      ...
                      <Star
                        fill="currentColor"
                        stroke="none"
                        className="w-5 h-5 text-neutral-300 dark:text-muted-foreground hover:text-yellow-400 transition"
                      />
                    )}
                  </button>
                </div>
